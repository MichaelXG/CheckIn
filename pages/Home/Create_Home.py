...
def Create_Home():  
    with st.container(): 
        ut.Divisor('Check in - Viagens', 'airplane-engines','rgb(20,80,90)', 'Home01')
        st.write('\n \n')
        ...
        with col1_d:
            st.write("""
7 - Desafio - Uma interface de agendamento de viagens recebe as seguintes informações como demonstrado 
no exemplo abaixo: \n
